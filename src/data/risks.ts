...
export const risks: Risk[] = [
  ...
  { id: 'R2', risk: 'DHL shipping time (5-7 days)', probability: 'HIGH', impact: 'HIGH', severity: 'CRITICAL', mitigation: 'Pre-position 20-30 items at US contact. Event Rental only uses pre-positioned items. Rent-to-Own = one-time ship, no urgency.' },
  ...
  { id: 'R4', risk: 'Returns logistics fail (US-side)', probability: 'MEDIUM', impact: 'HIGH', severity: 'HIGH', mitigation: 'Rent-to-Own has NO returns. Event Rental returns to pre-positioned contact. Only Membership has ongoing returns.' },
  ...
  { id: 'R9', risk: 'Cleaning turnaround too slow (US)', probability: 'LOW', impact: 'MEDIUM', severity: 'LOW', mitigation: 'Rent-to-Own needs NO cleaning. Event Rental: build 3-day buffer. Membership: 2+ cleaning partner options.' },
